...
# Running your own modified source instead? Build it from a checkout:
#   cd sub2api && bash deploy/docker-deploy-local.sh

# View logs
# (the script already started the services)
