<template>
  <section
    class="overflow-hidden rounded-2xl border border-gray-200/70 bg-white shadow-card dark:border-dark-700/60 dark:bg-dark-800"
  >
    <!-- 分组头部:名称/倍率徽章/专属/订阅徽章 + 描述(不展示平台信息) -->
