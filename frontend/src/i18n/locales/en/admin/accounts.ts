export default {
    accounts: {
      ...
      workbuddy: {
        realm: {
          label: 'Region',
          hint: 'The CN realm uses copilot.tencent.com; the global realm uses www.workbuddy.ai. The default endpoint updates when switched.',
          cn: 'CN (copilot.tencent.com)',
          global: 'Global (www.workbuddy.ai)',
        },
        accessToken: 'Access Token',
        refreshToken: 'Refresh Token',
        tokenPlaceholder: '••••••••',
        tokensHint: 'Provide at least one of Access Token or Refresh Token.',
        uid: 'UID',
        enterpriseId: 'Enterprise ID',
        deviceToken: 'Device Token',
        optionalPlaceholder: 'Optional',
        credentialsRequired: 'Please provide an Access Token or a Refresh Token',
        baseUrlHint: 'Defaults to the official endpoint of the selected region. Fill in an advanced override if needed.',
        oauthLogin: 'Sign in with OAuth to get credentials',
        oauthLoginHint: 'Generate an authorization link, finish the login in your browser, and this page will fill in the credentials automatically.',
        oauthGenerating: 'Generating…',
        oauthOpenHint: 'Open the link above in your browser to finish signing in. This page will detect the result automatically.',
        oauthWaiting: 'Waiting for authorization… (keep this dialog open)',
        oauthSuccess: 'OAuth authorization succeeded. Credentials have been filled in automatically.',
        oauthTimeout: 'OAuth authorization timed out. Please start the login again.',
        oauthRetry: 'Start login again',
        oauthCopy: 'Copy',
        oauthCopySuccess: 'Authorization link copied to clipboard',
        oauthFailedToGenerateUrl: 'Failed to generate the WorkBuddy authorization link',
        oauthFailedToExchange: 'Failed to exchange the WorkBuddy authorization code',
        oauthMissingState: 'Missing OAuth state. Please generate the authorization link again',
        oauthErrors: {},
        creditsRemain: 'Remaining credits',
        creditsRefresh: 'Refresh',
        creditsRefreshTooltip: 'Refresh remaining credits of the WorkBuddy account',
        creditsPackagesTitle: 'Packages',
        creditsUpdatedAt: 'Updated at',
        creditsEmpty: 'No credit data yet — click refresh',
        creditsEnterpriseNA: 'Managed by enterprise',
        creditsEnterpriseNATip: 'Enterprise member accounts have no personal credit pool (upstream returns an empty package list); quota and check-in eligibility are both granted by the enterprise admin console. This API does not expose enterprise quota, so a 0 balance is not misread as exhausted credits.',
        checkin: 'Check in',
        checkinTooltip: "Claim today's credits now",
        checkinDoneToday: 'Checked in today',
        checkinFailed: 'Check-in failed',
        checkinSkipped: 'Check-in unavailable',
        checkinEnterpriseTooltip: 'Enterprise member accounts have no personal check-in system; eligibility is granted by the enterprise admin console.',
        activityRun: 'Run task',
        activityRunTooltip: 'Run the conversation activity report now (includes the streak reward chain)',
        travelRun: 'Travel',
        travelRunTooltip: 'Run the buddy travel check now (adopt / depart / claim)',
        activitySnapshot: 'Streak {days}d · {reports} reports',
        travelActionAdopt: 'Ready to adopt',
        travelActionDepart: 'Departed',
        travelActionClaim: 'Reward claimed',
        travelActionSkip: 'No action',
      },
      qoder: {
        realm: {
          label: 'Site realm',
          hint: 'The CN realm uses gateway.qoder.com.cn; the global realm uses api1.qoder.sh. The default endpoint updates when switched.',
          cn: 'CN (gateway.qoder.com.cn)',
          global: 'Global (api1.qoder.sh)',
        },
        accessTokenLabel: 'Access Token / PAT',
        accessTokenHint: 'Accepts an OAuth Access Token, or paste a pt- / dt- / drt- token generated in Qoder IDE settings.',
        refreshTokenLabel: 'Refresh Token',
        refreshTokenHint: 'Refresh token returned by the OAuth login, used to renew the Access Token. Leave empty for manual tokens.',
        uidLabel: 'UID',
        uidHint: 'Qoder account user ID. Filled in automatically after a successful OAuth login; usually no need to enter manually.',
        nicknameLabel: 'Nickname',
        nicknameHint: 'Account display name for the list only; does not affect authentication.',
        baseUrlLabel: 'Base URL',
        baseUrlHint: 'Defaults to the official chat gateway endpoint of the selected realm. Fill in an override if needed.',
        oauthLogin: 'Sign in with OAuth to get credentials',
        oauthPending: 'Waiting for authorization… (keep this dialog open)',
        oauthSuccess: 'OAuth authorization succeeded. Credentials have been filled in automatically.',
        oauthTimeout: 'OAuth authorization timed out. Please start the login again.',
        oauthFailed: 'OAuth authorization failed. Please try again.',
        oauthHowTo: 'Click the button below to open the qoder.com authorization page. This page will return and fill in the credentials automatically once you finish signing in.',
        patHint: 'Alternatively, generate a pt- token (PAT) in Qoder IDE settings and paste it into the Access Token field.',
        credentialsRequired: 'Access Token / PAT is required',
        creditsRemain: 'Credits left',
        creditsRefresh: 'Refresh',
        creditsRefreshTooltip: 'Refresh remaining Qoder credits and campaign status',
        creditsPackagesTitle: 'Dedicated packages',
        creditsUpdatedAt: 'Updated at',
        creditsEmpty: 'No credit data yet — click refresh',
        creditsBreakdown: 'Plan {plan} / {planTotal}; add-on {addon} / {addonTotal}',
        campaignRound: 'Current round {key} (+{amount})',
        claim: 'Claim',
        claimTooltip: "Claim this round's campaign credits now",
        claimTooltipAmount: 'Claim {amount} credits now',
        claimDoneToday: 'Claimed this round',
        claimDoneTodayHint: 'One claim per round (campaign refreshes daily at 10:00)',
        claimFailed: 'Claim failed',
        claimSkipped: 'No campaign available',
      },
      trae: {
        realm: {
          label: 'Region',
          hint: 'CN talks to trae-api-cn.mchost.guru, global talks to a0ai-api-sg.byteintlapi.com; credits/check-in use the matching Trae API host. The default endpoint updates when switched.',
          cn: 'CN (trae.com.cn)',
          global: 'Global (trae.ai)',
        },
        accessToken: 'Access Token (IDE session)',
        accessTokenHint: 'Paste the session token captured from Trae IDE. It expires; refresh it with the Refresh Token below when requests start failing.',
        refreshToken: 'Refresh Token',
        tokenPlaceholder: '••••••••',
        tokensHint: 'Provide at least one of Access Token or Refresh Token.',
        uid: 'UID',
        ...
        ideVersionCode: 'IDE Version Code',
        ideVersionCodeHint: 'Determines which model catalog the upstream exposes to this account. Leave empty to use the backend default.',
        credentialsRequired: 'Please provide an Access Token or a Refresh Token',
        baseUrlHint: 'Defaults to the official endpoint of the selected region. Fill in an advanced override if needed.',
        billingBaseUrlLabel: 'Billing Base URL',
        billingBaseUrlHint: 'Optional override for the billing / credits endpoint (used by credit queries and check-in).',
        exchangeToken: 'Exchange token',
        exchangeTokenTooltip: 'Use the Refresh Token to fetch a new Access Token (the rotated Refresh Token overwrites the old one).',
        exchangeTokenLoading: 'Exchanging…',
        exchangeTokenSuccess: 'Token exchanged. Access Token and Refresh Token have been refreshed.',
        expiresAt: 'Token expires at',
        expiresAtHint: 'Auto-filled from the exchange response; click Exchange Token to recompute it.',
        exchangeTokenFailed: 'Token exchange failed',
        exchangeTokenMissingRefresh: 'Enter a Refresh Token before exchanging',
        creditsRemain: 'Remaining credits',
        creditsRefresh: 'Refresh',
        creditsRefreshTooltip: 'Refresh remaining Trae credits',
        creditsUsedOfTotal: 'Used {used} / {size}',
        creditsPackagesTitle: 'Entitlement packages',
        creditsPackKindCheckin: 'Check-in',
        creditsPackKindPlan: 'Plan',
        creditsPackKindOther: 'Other',
        creditsPackExpiresAt: 'expires {date}',
        creditsPackExpired: 'expired',
        creditsPacks: '{count} package(s)',
        creditsUpdatedAt: 'Updated at',
        creditsEmpty: 'No credit data yet — click refresh',
        creditsCheckinUnavailableTooltip: 'Check-in is not available for this account (no active check-in entitlement).',
        checkin: 'Check in',
        checkinTooltip: "Claim today's credits now",
        checkinDoneToday: 'Checked in today',
        checkinFailed: 'Check-in failed',
        checkinSkipped: 'Check-in unavailable',
        tokenExpiresAt: 'Access token expires',
        refreshTokenExpiresAt: 'Refresh token expires',
        tokenExpired: 'Token expired',
        tokenExpiredHint: 'The refresh token has expired — sign in to Trae again and paste new credentials.',
        tokenRenewable: 'Session renewing',
        tokenExpiringInHours: 'Expires in {hours}h',
        tokenExpiringInDays: 'Expires in {days}d',
        oauth: {
          title: 'Sign in to Trae in the browser to get credentials',
          steps: 'Click "Sign in with the browser" → finish the Trae login in the new tab → the address bar will stay on http://127.0.0.1:xxxx/authorize?... → copy the **whole URL** and paste it into the field below → click "Submit" to fill in the credentials automatically.',
          login: 'Sign in with the browser',
          generating: 'Generating the sign-in link…',
          openLink: 'Open again',
          copy: 'Copy',
          ...
          restart: 'Start the login again',
          countdownLabel: 'Session left',
          expired: 'The login session expired. Please start the login again.',
          callbackMissing: 'Paste the full URL from the browser address bar into the field first',
          sessionMissing: 'No browser login session yet. Click "Sign in with the browser" first',
          startFailed: 'Failed to generate the Trae sign-in link. Please try again.',
          submitFailed: 'Failed to submit the Trae login callback. Please start the login again.',
          ...
          errors: {
            ...
            TRAE_LOGIN_EXPIRED: 'The login session expired. Please start the login again and finish promptly.',
            TRAE_LOGIN_CALLBACK_ERROR: 'The authorization was rejected upstream (you may have declined the consent screen). Please start the login again.',
            TRAE_LOGIN_GUIDANCE_FAILED: 'Trae upstream login guidance failed. Retry later or switch to a proxy.',
            TRAE_LOGIN_EXCHANGE_FAILED: 'Trae upstream token exchange failed. Please start the login again later.'
          },
        },
      },
      types: {
      ...
      upstreamBilling: {
        ...
        batchSkippedIneligible: 'Skipped {count} account(s) that do not support rate probing (e.g. WorkBuddy)'
      },
      ...
      oauth: {
        ...
        sessionKeyPlaceholderSingle: 'xxxx-sid01-xxxxx...',
        ...
        sessionKeyFormat: 'sessionKey usually starts with xxxx-sid01-',
