export default {
  ...
  keys: {
    ...
    groupsRequired: 'Please select at least one group',
    groupsChangedSuccess: 'Groups updated successfully',
    failedToChangeGroups: 'Failed to update groups',
    moreGroups: '{count} more groups',
    primaryGroupBadge: 'Primary',
    primaryGroupHint: 'The group you check first is the primary group and decides the default platform used in the examples',
    mixedGroupTypeHint: 'Subscription and pay-as-you-go groups cannot be bound to the same key',
    ...
    bulkEdit: {
      ...
      groupHint: 'Multiple groups can be selected; submitting requires at least one. The first group becomes the primary one.'
    },
    ...
    useKeyModal: {
      ...
      primaryGroupNotice: 'This key is bound to multiple groups; only the primary group configuration is shown here.',
      openai: {
