export default {
    accounts: {
      ...
      upstreamBilling: {
        ...
        batchSkippedIneligible: '已跳过 {count} 个不支持倍率探测的账号（如 WorkBuddy）'
      },
      ...
      workbuddy: {
        realm: {
          label: '接入区域',
          hint: '国内域走 copilot.tencent.com，国际域走 www.workbuddy.ai；切换后自动更新默认端点。',
          cn: '国内（copilot.tencent.com）',
          global: '国际（www.workbuddy.ai）',
        },
        accessToken: 'Access Token',
        refreshToken: 'Refresh Token',
        tokenPlaceholder: '••••••••',
        tokensHint: 'Access Token 与 Refresh Token 至少填写一个。',
        uid: 'UID',
        enterpriseId: 'Enterprise ID',
        deviceToken: 'Device Token',
        optionalPlaceholder: '选填',
        credentialsRequired: '请至少填写 Access Token 或 Refresh Token',
        baseUrlHint: '默认使用所选区域的官方端点；如需自定义可填写高级覆盖地址。',
        oauthLogin: '通过 OAuth 登录获取凭据',
        oauthLoginHint: '点击下方按钮生成授权链接，在浏览器完成登录后本页面将自动回填凭据。',
        oauthGenerating: '生成中…',
        oauthOpenHint: '请在浏览器打开上述链接完成登录，页面将自动检测授权结果。',
        oauthWaiting: '等待授权完成…（请勿关闭本弹窗）',
        oauthSuccess: 'OAuth 授权成功，凭据已自动回填。',
        oauthTimeout: 'OAuth 授权超时，请重新发起登录。',
        oauthRetry: '重新发起登录',
        oauthCopy: '复制',
        oauthCopySuccess: '授权链接已复制到剪贴板',
        oauthFailedToGenerateUrl: '生成 WorkBuddy 授权链接失败',
        oauthFailedToExchange: 'WorkBuddy 授权码兑换失败',
        oauthMissingState: '缺少 OAuth state，请重新生成授权链接',
        oauthErrors: {},
        creditsRemain: '剩余积分',
        creditsRefresh: '查询',
        creditsRefreshTooltip: '查询 WorkBuddy 账户剩余积分',
        creditsPackagesTitle: '套餐明细',
        creditsUpdatedAt: '更新时间',
        creditsEmpty: '暂无积分数据，点击查询',
        creditsEnterpriseNA: '由企业后台管理',
        creditsEnterpriseNATip: '企业成员账号无个人积分资源池（上游返回空套餐列表），额度与签到资格均由企业管理后台分配；本接口不展示企业额度，避免把 0 误读成余额。',
        checkin: '签到',
        checkinTooltip: '立即领取今日积分',
        checkinDoneToday: '今日已签到',
        checkinFailed: '签到失败',
        checkinSkipped: '不支持签到',
        checkinEnterpriseTooltip: '企业成员账号无个人签到体系，签到资格由企业管理后台分配。',
        activityRun: '跑任务',
        activityRunTooltip: '立即执行对话活跃上报（含连登奖励链）',
        travelRun: '旅行',
        travelRunTooltip: '立即执行猫猫旅行巡检（领养 / 派出 / 领奖）',
        activitySnapshot: '连登 {days} 天 · 已发 {reports} 条',
        travelActionAdopt: '待领养',
        travelActionDepart: '已派出',
        travelActionClaim: '已领奖',
        travelActionSkip: '无动作',
      },
      qoder: {
        realm: {
          label: '站点区域',
          hint: '国内站走 gateway.qoder.com.cn，国际站走 api1.qoder.sh；切换后自动更新默认端点。',
          cn: '国内（gateway.qoder.com.cn）',
          global: '国际（api1.qoder.sh）',
        },
        accessTokenLabel: 'Access Token / PAT',
        accessTokenHint: '支持 OAuth Access Token，也可直接粘贴 Qoder IDE 设置中生成的 pt- / dt- / drt- 令牌。',
        refreshTokenLabel: 'Refresh Token',
        refreshTokenHint: 'OAuth 登录返回的刷新令牌，用于续期 Access Token；手动令牌方式可留空。',
        uidLabel: 'UID',
        uidHint: 'Qoder 账号用户 ID，OAuth 登录成功后自动回填，一般无需手动填写。',
        nicknameLabel: '昵称',
        nicknameHint: '账号备注名，仅用于列表展示，不影响鉴权。',
        baseUrlLabel: 'Base URL',
        baseUrlHint: '默认使用所选区域的官方 chat 网关端点；如需自定义可填写覆盖地址。',
        oauthLogin: '通过 OAuth 登录获取凭据',
        oauthPending: '等待授权完成…（请勿关闭本弹窗）',
        oauthSuccess: 'OAuth 授权成功，凭据已自动回填。',
        oauthTimeout: 'OAuth 授权超时，请重新发起登录。',
        oauthFailed: 'OAuth 授权失败，请重试。',
        oauthHowTo: '点击下方按钮打开 qoder.com 授权页，登录完成后本页面将自动返回并回填凭据。',
        patHint: '也可在 Qoder IDE 设置中生成 pt- 令牌（PAT），直接粘贴到 Access Token 输入框使用。',
        credentialsRequired: '请填写 Access Token / PAT',
        creditsRemain: '剩余 Credits',
        creditsRefresh: '查询',
        creditsRefreshTooltip: '查询 Qoder 账户剩余 Credits 与活动状态',
        creditsPackagesTitle: '专属资源包',
        creditsUpdatedAt: '更新时间',
        creditsEmpty: '暂无积分数据，点击查询',
        creditsBreakdown: '套餐内 {plan} / {planTotal}；资源包 {addon} / {addonTotal}',
        campaignRound: '本轮活动 {key}（+{amount}）',
        claim: '领取',
        claimTooltip: '立即领取本轮活动 Credits',
        claimTooltipAmount: '立即领取 {amount} Credits',
        claimDoneToday: '本轮已领取',
        claimDoneTodayHint: '每轮仅可领取一次（活动每日 10:00 刷新）',
        claimFailed: '领取失败',
        claimSkipped: '无可领活动',
      },
      trae: {
        realm: {
          label: '接入区域',
          hint: '国内站走 trae-api-cn.mchost.guru，国际站走 a0ai-api-sg.byteintlapi.com；积分与签到走对应的 Trae API 域名。切换后自动更新默认端点。',
          cn: '国内（trae.com.cn）',
          global: '国际（trae.ai）',
        },
        accessToken: 'Access Token（IDE 会话令牌）',
        accessTokenHint: '粘贴从 Trae IDE 抓取到的会话令牌；该令牌会过期，失效后可用下方 Refresh Token 换票刷新。',
        refreshToken: 'Refresh Token',
        tokenPlaceholder: '••••••••',
        tokensHint: 'Access Token 与 Refresh Token 至少填写一个。',
        uid: 'UID',
        ...
        ideVersionCodeHint: '决定上游向该账号开放哪一份可用模型表；留空则使用后端默认值。',
        credentialsRequired: '请至少填写 Access Token 或 Refresh Token',
        baseUrlHint: '默认使用所选区域的官方端点；如需自定义可填写覆盖地址。',
        billingBaseUrlLabel: '计费端点（Billing Base URL）',
        billingBaseUrlHint: '选填。积分查询与签到使用的计费端点覆盖地址，留空则按区域取默认值。',
        exchangeToken: '换票',
        exchangeTokenTooltip: '用 Refresh Token 换取新的 Access Token（轮换后的 Refresh Token 会覆盖旧值）。',
        exchangeTokenLoading: '换票中…',
        exchangeTokenSuccess: '换票成功，已回填新的 Access Token 与 Refresh Token。',
        expiresAt: '凭据到期时间',
        expiresAtHint: '由换票响应自动回填；点「换票」可重新获取。',
        exchangeTokenFailed: '换票失败',
        exchangeTokenMissingRefresh: '请先填写 Refresh Token 再换票',
        creditsRemain: '剩余积分',
        creditsRefresh: '查询',
        creditsRefreshTooltip: '查询 Trae 账户剩余积分',
        creditsUsedOfTotal: '已用 {used} / 总额 {size}',
        creditsPackagesTitle: '权益包明细',
        creditsPackKindCheckin: '签到包',
        creditsPackKindPlan: '套餐包',
        creditsPackKindOther: '其他',
        creditsPackExpiresAt: '{date} 到期',
        creditsPackExpired: '已过期',
        creditsPacks: '含 {count} 个积分包',
        creditsUpdatedAt: '更新时间',
        creditsEmpty: '暂无积分数据，点击查询',
        creditsCheckinUnavailableTooltip: '该账号当前无可签到权益包，签到入口不可用。',
        checkin: '签到',
        checkinTooltip: '立即领取今日积分',
        checkinDoneToday: '今日已签到',
        checkinFailed: '签到失败',
        checkinSkipped: '不支持签到',
        tokenExpiresAt: 'Access Token 到期',
        refreshTokenExpiresAt: 'Refresh Token 到期',
        tokenExpired: '凭据已过期',
        tokenExpiredHint: 'Refresh Token 已失效——必须重新登录 Trae 客户端并粘贴新凭据，无法自动续期。',
        tokenRenewable: '会话待刷新',
        tokenExpiringInHours: '{hours} 小时后到期',
        tokenExpiringInDays: '{days} 天后到期',
        oauth: {
          title: '通过浏览器登录 Trae 获取凭据',
          steps: '点「使用浏览器登录」→ 在新标签页完成 Trae 登录 → 浏览器地址栏会停在 http://127.0.0.1:xxxx/authorize?... 把**整串地址**复制粘回下方输入框 → 点「提交」即可自动回填凭据。',
          login: '使用浏览器登录',
          generating: '正在生成登录链接…',
          openLink: '重新打开',
          copy: '复制',
          copySuccess: '登录链接已复制到剪贴板',
          popupBlocked: '浏览器拦截了新标签页，请点击上方链接手动打开授权页。',
          unreachableNote: '登录完成后地址栏页面显示「无法访问此网站」是正常现象——回调只打到本机端口，并没有服务在监听；只需复制地址栏整串链接粘回即可。',
          callbackLabel: '回调地址（浏览器地址栏整串）',
          callbackPlaceholder: 'http://127.0.0.1:xxxx/authorize?...',
          submit: '提交',
          submitting: '提交中…',
          restart: '重新发起登录',
          countdownLabel: '会话剩余',
          expired: '登录会话已过期，请重新发起',
          callbackMissing: '请先把浏览器地址栏整串链接粘回输入框',
          sessionMissing: '尚未发起浏览器登录，请先点「使用浏览器登录」',
          startFailed: '生成 Trae 登录链接失败，请重试。',
          submitFailed: 'Trae 登录提交失败，请重新发起登录。',
          success: '登录成功，凭据已自动回填。',
          errors: {
            TRAE_LOGIN_CALLBACK_INVALID: '粘贴的回调地址不完整或不是授权页地址——请复制浏览器地址栏的整串链接（含 ?code=...）后重新提交。',
            TRAE_LOGIN_TRACE_MISMATCH: '回调地址与本次登录会话不匹配（可能粘了旧标签页的链接），请重新发起登录。',
            TRAE_LOGIN_NO_CODE: '回调地址里没有携带授权码，请确认复制的是登录完成后浏览器地址栏的整串链接。',
            TRAE_LOGIN_NOT_FOUND: '登录会话不存在（服务可能已重启），请重新发起登录。',
            TRAE_LOGIN_EXPIRED: '登录会话已过期，请重新发起登录并尽快完成操作。',
            TRAE_LOGIN_CALLBACK_ERROR: '上游拒绝了本次授权（可能点了拒绝或授权被取消），请重新发起登录。',
            TRAE_LOGIN_GUIDANCE_FAILED: 'Trae 上游登录引导失败，请稍后重试或改用代理。',
            TRAE_LOGIN_EXCHANGE_FAILED: 'Trae 上游换票失败，请稍后重新发起登录。'
          },
        },
      },
      types: {
      ...
      oauth: {
        ...
        step6: '复制 Value 列的值',
        sessionKeyFormat: 'sessionKey 通常以 xxxx-sid01- 开头',
