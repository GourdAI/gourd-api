export default {
  ...
  keys: {
    ...
    selectGroups: '选择分组',
    searchGroups: '搜索分组...',
    noGroupsFound: '未找到匹配的分组',
    groupsRequired: '请至少选择一个分组',
    groupsChangedSuccess: '分组修改成功',
    failedToChangeGroups: '修改分组失败',
    moreGroups: '还有 {count} 个分组',
    primaryGroupBadge: '主分组',
    primaryGroupHint: '主分组为你最先勾选的分组，决定使用示例的默认平台',
    mixedGroupTypeHint: '订阅型分组与按量付费分组不能绑定到同一个密钥',
    columnSettings: '列设置',
    ...
    bulkEdit: {
      ...
      groupHint: '可多选；未勾选任何分组时无法提交。首个分组为主分组。'
    },
    deleteKey: '删除密钥',
    ...
    useKeyModal: {
      ...
      primaryGroupNotice: '该密钥绑定了多个分组，此处仅展示主分组的配置示例。',
      openai: {
