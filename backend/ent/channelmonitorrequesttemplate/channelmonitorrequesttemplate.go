...
const (
	...
	ProviderQoder       Provider = "qoder"
	ProviderTrae        Provider = "trae"
)
...
func ProviderValidator(pr Provider) error {
	switch pr {
	case ProviderOpenai, ProviderAnthropic, ProviderGemini, ProviderGrok, ProviderAntigravity, ProviderKimi, ProviderZhipu, ProviderDeepseek, ProviderMinimax, ProviderOpencodeGo, ProviderWorkbuddy, ProviderQoder, ProviderTrae:
		return nil
	default:
