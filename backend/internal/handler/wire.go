...
func ProvideAdminHandlers(
	...
	workBuddyOAuthHandler *admin.WorkBuddyOAuthHandler,
	workBuddyCreditsHandler *admin.WorkBuddyCreditsHandler,
	qoderOAuthHandler *admin.QoderOAuthHandler,
	qoderCreditsHandler *admin.QoderCreditsHandler,
	traeCreditsHandler *admin.TraeCreditsHandler,
	traeLoginHandler *admin.TraeLoginHandler,
	...
	return &AdminHandlers{
		...
		WorkBuddyOAuth:         workBuddyOAuthHandler,
		WorkBuddyCredits:       workBuddyCreditsHandler,
		QoderOAuth:             qoderOAuthHandler,
		QoderCredits:           qoderCreditsHandler,
		TraeCredits:            traeCreditsHandler,
		TraeOAuth:              traeLoginHandler,
...
func ProvideOpenAIGatewayHandler(
	...
	// 防封加固：为启用了 TLS 指纹的账号接入出站 TLS 伪装（OpenAI/Grok/OpenCode 等）。
...
var ProviderSet = wire.NewSet(
	...
	admin.NewWorkBuddyOAuthHandler,
	admin.NewWorkBuddyCreditsHandler,
	admin.NewQoderOAuthHandler,
	admin.NewQoderCreditsHandler,
	admin.NewTraeCreditsHandler,
	admin.NewTraeLoginHandler,
