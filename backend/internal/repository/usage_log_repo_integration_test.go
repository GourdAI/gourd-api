...
func TestUsageLogRepositoryCreate_BatchPathConcurrent(t *testing.T) {
	...
	apiKey := mustCreateApiKey(t, client, &service.APIKey{UserID: user.ID, Key: "tk-usage-batch-" + uuid.NewString(), Name: "k"})
...
func TestUsageLogRepositoryCreate_BatchPathDuplicateRequestID(t *testing.T) {
	...
	apiKey := mustCreateApiKey(t, client, &service.APIKey{UserID: user.ID, Key: "tk-usage-dup-" + uuid.NewString(), Name: "k"})
...
func TestUsageLogRepositoryFlushCreateBatch_DeduplicatesSameKeyInMemory(t *testing.T) {
	...
	apiKey := mustCreateApiKey(t, client, &service.APIKey{UserID: user.ID, Key: "tk-usage-batch-memdup-" + uuid.NewString(), Name: "k"})
...
func TestUsageLogRepositoryCreateBestEffort_BatchPathDuplicateRequestID(t *testing.T) {
	...
	apiKey := mustCreateApiKey(t, client, &service.APIKey{UserID: user.ID, Key: "tk-usage-best-effort-dup-" + uuid.NewString(), Name: "k"})
...
func TestUsageLogRepositoryCreate_BatchPathCanceledContextMarksNotPersisted(t *testing.T) {
	...
	apiKey := mustCreateApiKey(t, client, &service.APIKey{UserID: user.ID, Key: "tk-usage-cancel-" + uuid.NewString(), Name: "k"})
...
func TestUsageLogRepositoryCreate_BatchPathQueueFullMarksNotPersisted(t *testing.T) {
	...
	apiKey := mustCreateApiKey(t, client, &service.APIKey{UserID: user.ID, Key: "tk-usage-create-full-" + uuid.NewString(), Name: "k"})
...
func TestUsageLogRepositoryCreate_BatchPathCanceledAfterQueueMarksNotPersisted(t *testing.T) {
	...
	apiKey := mustCreateApiKey(t, client, &service.APIKey{UserID: user.ID, Key: "tk-usage-cancel-queued-" + uuid.NewString(), Name: "k"})
...
func TestUsageLogRepositoryFlushCreateBatch_CanceledRequestReturnsNotPersisted(t *testing.T) {
	...
	apiKey := mustCreateApiKey(t, client, &service.APIKey{UserID: user.ID, Key: "tk-usage-flush-cancel-" + uuid.NewString(), Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetByID_ReturnsAccountRateMultiplier() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-getbyid-mult", Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetByID_ReturnsOpenAIWSMode() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-getbyid-ws", Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetByID_ReturnsRequestTypeAndLegacyFallback() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-getbyid-request-type", Name: "k"})
...
func (s *UsageLogRepoSuite) TestListByUser() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-listbyuser", Name: "k"})
...
func (s *UsageLogRepoSuite) TestListByAPIKey() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-listbyapikey", Name: "k"})
...
func (s *UsageLogRepoSuite) TestListByAccount() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-listbyaccount", Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetUserStats() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-userstats", Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetUserDashboardStats() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-userdash", Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetAccountTodayStats() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-acctoday", Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetBatchApiKeyUsageStats() {
	...
	apiKey1 := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-batchkey1", Name: "k1"})
	apiKey2 := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-batchkey2", Name: "k2"})
...
func (s *UsageLogRepoSuite) TestListByUserAndTimeRange() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-timerange", Name: "k"})
...
func (s *UsageLogRepoSuite) TestListByAPIKeyAndTimeRange() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-keytimerange", Name: "k"})
...
func (s *UsageLogRepoSuite) TestListByAccountAndTimeRange() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-acctimerange", Name: "k"})
...
func (s *UsageLogRepoSuite) TestListByModelAndTimeRange() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-modeltimerange", Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetAccountWindowStats() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-windowstats", Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetUserUsageTrendByUserID() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-usertrend", Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetUserUsageTrendByUserID_HourlyGranularity() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-usertrendhourly", Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetUserModelStats() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-modelstats", Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetUsageTrendWithFilters() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-trendfilters", Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetUsageTrendWithFilters_HourlyGranularity() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-trendfilters-h", Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetModelStatsWithFilters() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-modelfilters", Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetAccountUsageStats() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-accstats", Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetUserUsageTrend() {
	...
	apiKey1 := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user1.ID, Key: "tk-usertrend1", Name: "k1"})
	apiKey2 := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user2.ID, Key: "tk-usertrend2", Name: "k2"})
...
func (s *UsageLogRepoSuite) TestGetAPIKeyUsageTrend() {
	...
	apiKey1 := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-keytrend1", Name: "k1"})
	apiKey2 := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-keytrend2", Name: "k2"})
...
func (s *UsageLogRepoSuite) TestGetAPIKeyUsageTrend_HourlyGranularity() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-keytrendh", Name: "k"})
...
func (s *UsageLogRepoSuite) TestListWithFilters_ApiKeyFilter() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-filterskey", Name: "k"})
...
func (s *UsageLogRepoSuite) TestListWithFilters_TimeRange() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-filterstime", Name: "k"})
...
func (s *UsageLogRepoSuite) TestListWithFilters_CombinedFilters() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "tk-filterscombined", Name: "k"})
