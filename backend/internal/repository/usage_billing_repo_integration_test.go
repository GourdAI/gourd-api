...
func TestUsageBillingRepositoryApply_DeduplicatesBalanceBilling(t *testing.T) {
	...
	apiKey := mustCreateApiKey(t, client, &service.APIKey{
		UserID: user.ID,
		Key:    "tk-usage-billing-" + uuid.NewString(),
		Name:   "billing",
		Quota:  1,
	})
...
func TestUsageBillingRepositoryApply_DeduplicatesSubscriptionBilling(t *testing.T) {
	...
	apiKey := mustCreateApiKey(t, client, &service.APIKey{
		UserID:  user.ID,
		GroupID: &group.ID,
		Key:     "tk-usage-billing-sub-" + uuid.NewString(),
		Name:    "billing-sub",
	})
...
func TestUsageBillingRepositoryApply_RequestFingerprintConflict(t *testing.T) {
	...
	apiKey := mustCreateApiKey(t, client, &service.APIKey{
		UserID: user.ID,
		Key:    "tk-usage-billing-conflict-" + uuid.NewString(),
...
func TestUsageBillingRepositoryApply_UpdatesAccountQuota(t *testing.T) {
	...
	apiKey := mustCreateApiKey(t, client, &service.APIKey{
		UserID: user.ID,
		Key:    "tk-usage-billing-account-" + uuid.NewString(),
...
func TestUsageBillingRepositoryApply_EnqueuesSchedulerOutboxOnQuotaCrossing(t *testing.T) {
	...
	newFixture := func(t *testing.T, extra map[string]any) (int64, int64) {
		...
		apiKey := mustCreateApiKey(t, client, &service.APIKey{
			UserID: user.ID,
			Key:    "tk-usage-billing-outbox-" + uuid.NewString(),
			Name:   "billing-outbox",
		})
		account := mustCreateAccount(t, client, &service.Account{
...
func TestUsageBillingRepositoryApply_DeduplicatesAgainstArchivedKey(t *testing.T) {
	...
	apiKey := mustCreateApiKey(t, client, &service.APIKey{
		UserID: user.ID,
		Key:    "tk-usage-billing-archive-" + uuid.NewString(),
