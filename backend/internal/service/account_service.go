...
func (s *AccountService) TestCredentials(ctx context.Context, id int64) error {
	...
	case PlatformGrok:
		...
		return nil
	case PlatformKimi, PlatformZhipu, PlatformDeepseek, PlatformMiniMax, PlatformOpenCodeGo, PlatformWorkbuddy, PlatformQoder:
		// 国产 OpenAI 兼容供应商与 OpenCode/WorkBuddy/Qoder：凭证为 API Key 或设备/会话令牌，实际可用性经余额/额度探测与转发路径验证。
		return nil
	default:
