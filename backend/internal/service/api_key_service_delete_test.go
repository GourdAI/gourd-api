...
func TestAPIKeyService_List_SortByCurrentConcurrency(t *testing.T) {
	groupID := int64(42)
	keys := []APIKey{
		{ID: 1, UserID: 7, Key: "tk-target-1", Name: "target-one", GroupID: &groupID, Status: StatusActive},
		{ID: 2, UserID: 7, Key: "tk-target-2", Name: "target-two", GroupID: &groupID, Status: StatusActive},
		{ID: 3, UserID: 7, Key: "tk-target-3", Name: "target-three", GroupID: &groupID, Status: StatusActive},
		{ID: 4, UserID: 7, Key: "tk-target-4", Name: "target-four", GroupID: &groupID, Status: StatusActive},
		{ID: 9, UserID: 7, Key: "tk-target-9", Name: "target-inactive", GroupID: &groupID, Status: StatusDisabled},
		{ID: 10, UserID: 7, Key: "tk-other-10", Name: "other", GroupID: &groupID, Status: StatusActive},
		{ID: 11, UserID: 7, Key: "tk-target-11", Name: "target-no-group", Status: StatusActive},
		{ID: 12, UserID: 8, Key: "tk-target-12", Name: "target-other-user", GroupID: &groupID, Status: StatusActive},
	}
